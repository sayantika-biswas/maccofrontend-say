...
import BenefitsFlutter from "../Component/BenefitsFlutter/page";
import WhyChooseFlutter from "../Component/WhyChooseFlutter/page";
import Banner from "../Component/Banner/page";
import Footerpage from "../Component/Footerpage/page";
import HireFlutterDeveloper from "../Component/HireFlutterDeveloper/page";

const FlutteAppDevelopment = () => {
  ...
  return (
    <div>
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row justify-between items-center relative z-10">
            ...
            >
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
                Flutter App Development Company in the India
              </h1>
              <p className="text-indigo-200 mb-2">
                Build high-performance, cross-platform mobile apps faster with
                our Flutter app development services.
              </p>
              <p className="text-indigo-200 mb-6 text-sm md:text-base">
                At <strong>Macco Tech</strong>, we specialize in Flutter app
                development to create beautiful, natively compiled applications
                for mobile, web, and desktop from a single codebase. Our expert
                team ensures faster time-to-market, smooth UI experiences, and
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-14 md:py-20 overflow-hidden">
        <motion.div
          className="container mx-auto px-4 md:px-8 lg:px-12 flex flex-col lg:flex-row items-center gap-10"
          initial="hidden"
          whileInView="visible"
        ...
        >
          {/* Left: Image */}
          <motion.div
            className="w-full lg:w-1/2 relative h-[220px] md:h-[380px] lg:h-[390px]"
            initial={{ opacity: 0, x: -100 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <Image
              src="/flutter-banner.webp"
              alt="Flutter App Development Illustration"
              fill
              priority
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <motion.h1
              ...
              transition={{ duration: 0.6, ease: "easeOut" }}
            >
              <span className="text-blue-700">Macco Tech:</span> Revolutionizing
            ...
            >
              At <span className="font-semibold text-blue-600">Macco Tech</span>
              , we craft powerful and visually striking mobile apps using
              Flutter and Agile development.
            </motion.p>
            ...
            >
              Delivering seamless performance across iOS, Android, and Web — we
              provide complete end-to-end Flutter app development solutions.
            </motion.p>
            ...
            >
              Be it enterprise software or consumer apps, our expert Flutter
              developers bring your vision to reality with innovation and
              precision.
            </motion.p>

            <motion.p
              className="text-lg md:text-xl font-semibold text-blue-700 mt-6 animate-pulse"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ delay: 0.4, duration: 0.6 }}
            >
              Let&apos;s build your next-gen app with Macco Tech!
            </motion.p>
          </div>
        </motion.div>
      </section>
...
export default FlutteAppDevelopment;
